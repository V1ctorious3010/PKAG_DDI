...
targeting the user's repository: https://github.com/V1ctorious3010/PKAG_DDI
"""
...
cells.append({
    ...
    "source": [
        ...
        "\n",
        "# Clone PKAG-DDI repository from user's GitHub\n",
        "!git clone https://\"$secret_value_0\"@github.com/V1ctorious3010/PKAG_DDI pkag_ddi || git clone https://github.com/V1ctorious3010/PKAG_DDI pkag_ddi\n",
        "%cd pkag_ddi\n"
    ]
})
...
print("Successfully generated e:/PKAG DDI/pkag-ddi-drugbank.ipynb pointing to https://github.com/V1ctorious3010/PKAG_DDI")
